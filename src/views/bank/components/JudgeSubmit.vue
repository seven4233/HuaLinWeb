...
const handleContinue = () => {
  Modal.confirm({
      ...
      //   页面跳转
        go('/bank/'+Number(route.params.id)+'/judge')
      }
    }
  )
};
      ...
      <div class="submit_header">
        <div class="result_wrap">
          <img
            ...
            alt="" />
          <div class="text">
            <div class="bfb">{{ judgeStore.correctPercent }}</div>
            %
        ...
        <div class="result_wrap">
          <img
            ...
            alt="" />
          <div class="text">
            <div class="bfb">{{ judgeStore.correctCount }}</div>
            /5
        ...
        <div class="result_wrap">
          <img
            ...
            alt="" />
          <div class="text">
            <div class="bfb">{{ judgeStore.doneCount }}</div>
            /{{ judgeStore.totalCount }}
