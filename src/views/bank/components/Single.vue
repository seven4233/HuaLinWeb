  ...
  <div id="single" class="single">
    <div class="header">
      <div class="header-content">
        ...
        <!-- 答题卡圈圈 (提交之后)-->
        <div v-else class="answer_card_list">
          <span style="margin-right: 10px; font-size: 14px; color: #666">答题卡</span>
          <div class="answer_card_item" v-for="(item, index) in cardNumList" :key="item.value"
               @click="cardNumClick(index)">
            <div style="margin-right: 8px; padding-top: 4px">
        ...
        <div v-if="!singleStore.isSubmit" class="header-submitter">
          <div class="ab" @click="handleSubmit">
            <div class="cd">交卷</div>
          </div>
        </div>
        <div v-else class="header-submitter">
    ...
    <!-- 提交之前 -->
    <div v-if="!singleStore.isSubmit" class="page-wrapper">
    ...
    <!-- 提交之后 -->
    <div v-else class="page-wrapper-submit" id="header">
